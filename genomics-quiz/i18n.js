...
(function(){
  ...
  const STR = {
    ...
    quizAllChapters: { zh:"基因體學互動考題（全部章節）", en:"Genomics Interactive Quiz (All Chapters)" },
    quizErrataTitle: { zh:"基因體學互動考題", en:"Genomics Interactive Quiz" },
